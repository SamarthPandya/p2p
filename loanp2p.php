    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="login100-more" style="background-color:#1a1a1a;">
                <p style="padding: 5px;font-size: 16px;color: white">Please read these Terms of Use/Terms and Conditions carefully before using Fin-Tech.in (the ‘website’ or the ‘Site’), owned by the company Fin-Tech Online Services Private Limited (the ‘Company’ or ‘Fin-Tech). This agreement sets forth the legally binding terms and conditions for Campaigners, funders and Visitors (collectively called “Users”) of the website. By using the service/services in any manner, including, but not limited to, visiting or browsing the site or contributing content, information, or other materials or services to the site, you agree to be bound by this agreement.
                    ...
                    iv. is in violation of any applicable law or contractual obligation.
                    ...
                    • Are not the final recipients of any funds from the Funders directly, but a service provider, which enables receipt of funds (both domestic and foreign) by campaign owners, who are the final recipient of funds.
                    ...
                    • Makes refunds after deducting necessary transaction fee to the funder.
                    • Does not generate contributions and Funderss for a campaign.
                    ...
                    Exclusivity
                    The Campaigner shall not, directly or indirectly, run or be associated with any other crowdfunding campaigns on any other platform, or directly or indirectly, run an independent or separate crowdfunding campaign at any time during the period the Campaigner is crowdfunding on Fin-Tech.
                    The Campaigner shall be liable for any and all damages or losses, including indirect or consequential damages or losses, arising from or in relation to the breach of the above exclusivity clause and the Campaigner agrees to indemnify and hold Fin-Tech harmless in case of any such damages or losses.
                    Project submission and evaluation
                    Campaigners have to go through a free mandatory evaluation process in order to get selected by the Site for the purpose of hosting their campaign and raising funds. The mandatory questions on the evaluation form have to be filled before a campaigner can be reviewed. Project details submitted in the evaluation form are kept confidential within the Company, however Fin-Tech does not ensure that it would prevent any leakage of information outside.
                    Campaign approval or rejection
                    The Company follows proprietary guidelines and criteria while selecting a campaign/project for the purpose of raising funds on the Site. Only those campaigners, whose projects are approved by the Company, are allowed to raise funds on the Site by running their campaigns. The Company reserves the right to select or approve a campaign as per these guidelines and also reserves the right to communicate or not communicate the reasons for rejection. Approved campaigners have to pay Fees as defined below before going ahead to create and run their campaigns.
                    Fee structure
                    The Campaigner agrees to pay Fin-Tech the following fees in relation to the Campaigner’s crowdfunding campaign(s):
                    • Upfront Non refundable fee of Rs. 3,500 to be paid within 7 days of your campaign getting approved. GST and other taxes, if any, shall be payable on this amount at the rates applicable as on the date of payment.
                    • Campaign commission of 10%, to be charged on the total amount of funds raised at the end of your campaign, if your campaign meets or exceeds its funding goal successfully (There shall be NO additional Payment Gateway charges). GST and other taxes, if any, shall be payable on this amount at the rates applicable as on the date of campaign settlement.
                    • Fees towards Digital Marketing and PR services: These are optional services which shall be charged at Rs. 10,000. This money has to be paid to Fin-Tech together with the upfront fee. GST and other taxes, if any, shall be payable on this amount at the rates applicable as on the date of payment.
                    This money has to be paid to Fin-Tech within 10 days of onboarding with your campaign consultant. Service Tax and other taxes, if any, shall be payable on this amount at the rates applicable as on the date of payment.
                    Non-negotiation clause
                    The Campaigner hereby agrees to pay Fin-Tech’s fee as listed above. Fin-Tech fee is non-refundable and non-negotiable under any circumstances.
                    Exclusivity
                    Campaigners shall not, directly or indirectly, run or be associated with any other crowdfunding campaigns on any other platform while crowdfunding on the Site through Fin-Tech, for the same project.
                    Campaign setup
                    Campaigners are solely responsible for creating their own campaign pages within the format provided by Fin-Tech. Campaigners must source all relevant content including text, images, and videos themselves. You further agree that your content or any other submission will not contain third party copyrighted material, or material that is subject to other third-party proprietary rights, unless you have permission from the rightful owner of the material or you are otherwise legally entitled to post the material and to grant the Site all of the license rights granted herein. You will pay all royalties and other amounts owed to any person or entity based on your submitting content to the Site or the Company's publishing or hosting of the content as contemplated by these Terms of Use. The use or other exploitation of content by the Company and Users as contemplated by this agreement will not infringe or violate the rights of any third party. Furthermore, all information publicly posted or privately transmitted through the Site is the sole responsibility of the person from which that content originated. The Company will not be liable for any errors or omissions in any content. The Company cannot guarantee the identity of any other Users with whom you may interact while using the Site. All content you access through the Site is at your own risk and you will be solely responsible for any resulting damage or loss to any party. No campaign with Fin-Tech can launch before Fin-Tech has approved all the campaign page elements i.e., the pitch video, pledge content, images, team bios etc. The Company shall have the right to delete, edit, modify, reformat, excerpt, or translate any of your content. Fin-Tech feedback to change the elements, if given to the campaigner, must be implemented by the campaigner. Fin-Tech holds the right to disallow unsatisfactory campaigns from going live on our platform.
                    Campaign target & timeline
                    The Campaigner is not allowed to change the funding goal and/or time period, after his campaign has one live and made available to public on Fin-Tech.
                    Campaign marketing
                    The Campaigner is solely responsible for marketing his campaign to friends, family members, and fans, through various online & offline channels. Fin-Tech will only provide marketing guidance in the form of a pre-live marketing strategy and marketing tips & tricks post campaign launch. If a campaigner has paid for Digital marketing and PR services to Fin-Tech, the services provided are only restricted to running Facebook ads and getting the digital and press media to cover the campaign. However, Fin-Tech does not, under any circumstances whatsoever, guarantee campaign success. All risk in relation to the success or failure of the campaign shall lie solely with the Campaigner.
                    Fin-Tech may, at its sole discretion, showcase live campaigns in the “Discover” section of its website. Fin-Tech also reserves the right to select & market any campaign as “Favorites” or in its periodic emailers to its database or on its Facebook and Twitter profiles. Campaign performance may influence selection but does not ensure it.
                    All or Nothing policy
                    Every campaign has a funding goal and only up to 60 days to reach this funding goal. If the campaign does not reach its funding goal within this time period, the funds collected are refunded to the Funders by Fin-Tech. All payments shall be refunded via their original modes of payment, i.e. all online payment shall be refunded as a transaction reversal and all offline payments shall be issued a cheque. In such cases, Fin-Tech shall not levy its commission. However, the payment gateways shall charge their relevant fees (depending on method of payment). Additionally, a fee of Rs. 30 to 90 is charged for cheque couriers if the money is returned via cheques. All refunds shall be processed within 15 days of the campaign end date.
                    Reporting
                    All campaigners are provided all information about their funders such as name, email, contributions, rewards etc., in the analytics section of the campaigner profile. Fin-Tech enables complete transparency of funds collected through real time emails for every funding transaction & funder reports downloadable at the discretion of campaigners. However, Fin-Tech is not liable for incorrect funder information provided by funders. Campaigner must connect with Funders directly, without involving the Site or the Company, to get any other information other than contacts details or other than the details of the Funders provided by Fin-Tech to the campaigner.
                    Fund transfer and management
                    Fin-Tech only enables the flow of funds from funders to Campaigners and is not the final recipient of funds raised (other than commission payable by the Campaigner) on its platform.
                    For all Campaigns which successfully reach their fund targets, fund transfers are only made to Indian bank accounts after 15 days of the end of the campaign through net transfer or by cheque. Fin-Tech shall deduct all fees including GST and other taxes, if any as listed above and thereafter transfers the net amount.
                    If the Campaigner has not met his funding goal within the stipulated time period, the funds are transferred back to funders. The payment gateways shall deduct their commission on such refunds. Fin-Tech shall not charge any commission on such 'Unsuccessful Campaigns.'
                    Fund transfer in case of Indian based and Foreign based Campaigns.
                    Campaigns may be either
                    1. India based (i.e. campaigns where campaigners seek to implement the project in India and accordingly, have an Indian bank account into which the campaign funder’s contributions may be released) or
                    2. foreign based (i.e. campaigns where campaigners seek to implement the project outside India and accordingly have a foreign bank account into which the campaign funder’s contributions may be released).
                    Incase of India based campaigns, all contributions made by funders through Indian bank accounts/ Indian credit / debit cards or other Indian payment instruments shall be initially received into a Fin-Tech India account (in India) and all contributions made by funders through foreign bank accounts/ foreign credit / debit cards or other foreign payment instruments shall be initially received into a Fin-Tech USA account (in USA). Such funds shall thereafter, depending on whether the campaign is successful or not, be transferred to the bank account of the campaigner or refunded to the relevant funders. It is clarified that incase of unsuccessful campaigns, payment gateway charges (if applied by the relevant payment gateway) shall be applicable at the time of refund.
                    Incase of foreign based campaigns, all contributions made by funders, irrespective of the nature of bank account or payment instrument, shall be initially received into a Fin-Tech USA account (in USA). Such funds shall thereafter, depending on whether the campaign is successful or not, be transferred to the bank account of the campaigner or refunded to the relevant funders. It is clarified that incase of unsuccessful campaigns, payment gateway charges (if applied by the relevant payment gateway) shall be applicable at the time of refund.
                    Foreign funds
                    All foreign contributions shall be required to be made in strict compliance with Foreign Contribution Regulation Act, 1976. The campaigner represents and warrants that it is aware of the Foreign Contribution Regulation Act, 1976 and its contents and is seeking contributions in full compliance with the provisions of Foreign Contribution Regulation Act, 1976. Further, the campaigner covenants that it shall, at all times, remain in absolute and full compliance with the provisions of Foreign Contribution Regulation Act, 1976, in relation to the campaign.

                    The campaigner agrees that Fin-Tech is relying on the Campaigner’s specific representation of compliance with Foreign Contribution Regulation Act, 1976 and is agreeing to enter into this agreement based on such representation. In the event that such representation is inaccurate, false or misleading, the campaigner shall solely be responsible and liable and shall indemnity Fin-Tech for any and all direct or indirect, loss or damage suffered by Fin-Tech.

                    Only if the Campaigner is an NGO, it shall have to be registered/approved with Foreign Contribution Regulation Act, 1976 to be able to receive foreign contributions. Else foreign contributions will be restricted on such Campaigner’s campaign.
                    Taxation
                    Campaigners must bear any and all tax liabilities on the funds raised through Fin-Tech. These taxes may include, but are not limited to, income tax, VAT, service tax and GST applicable on the fund's raised or on the procurement of rewards. Fin-Tech is not liable to provide any tax or legal advice to Campaigners. Information provided in Fin-Tech FAQs are only a guideline and subject to change without notice.
                    Use of funds
                    The campaigner must use the funds collected through Fin-Tech solely for the project described in their crowdfunding campaign. Campaigners shall be liable to legal prosecution by Funders and/or Fin-Tech (jointly and severally) if they are found to be using funds for any purpose other than that specified at the time of raising the funds, or other inappropriate purposes. The Site can discontinue the campaign if it gets any notification of misuse of funds or use of funds for another purpose other than the stated creative project at any time of the campaign, without any notice or discussion to the campaign owner at the Company's sole discretion.
                    Project completion
                    ...
                    The Company or the Site does not make any claims or guarantees on behalf of the campaigner regarding the completion of the project and usage of the funds raised solely for the purpose of the project.
                    Similarly, the Company or the Website does not take any responsibility for making sure that the project for which the funds are raised through its Site is completed and made available to the Funders. The Funders are free to get in touch with the campaign owner directly and solving any dispute that arises regarding the campaign or the project.
                    Campaign rewards
                    Campaigners must offer at least 3 rewards to funders in exchange for their funding. These rewards cannot, under any circumstances, be financial in nature (e.g., interest on funding amount, ownership/equity stake, revenue/profit share).
                    Campaigners are solely responsible for the procurement and delivery of rewards to funders and must meet the rewards delivery date specified by them on the campaign page.
                    Fin-Tech will not be responsible for any liabilities resulting from funders' dissatisfaction with rewards fulfilment. Campaigners acknowledge that they are aware that funders may take legal action if they don not receive the rewards promised by the campaigner by the specified timeline.
                    Fin-Tech branding & marketing
                    Campaigners must include Fin-Tech logo branding on all project and/or campaign related marketing collaterals, whether online or offline (e.g., online banners, offline flyers) as per Fin-Tech brand and logo guidelines. Fin-Tech should be credited as the project's "Online Crowdfunding Partner" at campaign or project related offline events. Also successful campaigners are obliged and undertake to attend and/or lead Fin-Tech branding & marketing activities such as events, ad videos, interviews, etc.
                    Campaign cancellation
                    Notwithstanding anything set out herein, Fin-Tech reserves the right, at its sole discretion, to reject, cancel, interrupt, remove, or suspend a campaign at any time and for any reason. Fin-Tech is not liable for any damages as a result of any of those actions. Fin-Tech policy is not to comment on the reasons for any of those actions.
                    Fin-Tech rights
                    Fin-Tech shall have the right to:
                    1. make changes in its technology platform or services, at its sole discretion, at any time, without notice or liability.
                    2. decide who’s eligible to use the services offered by Fin-Tech.
                    3. cancel accounts or decline to offer our services.
                    4. change our eligibility criteria at any time.
                    5. cancel any funding to any project, at any time and for any reason.
                    6. reject, cancel, interrupt, remove, or suspend any project at any time and for any reason.
                    Fin-Tech is not liable for any damages as a result of any of these actions, and it is our policy not to comment on the reasons for any such action.
                    Fin-Tech will not have any ownership rights over your User Submissions and Content. However, Fin-Tech will get the license to perform and market the Site on your behalf and on behalf of its other Users and itself. You grant to the Company the worldwide, non-exclusive, perpetual, irrevocable, royalty-free, sublicensable, transferable right to (and to allow others acting on its behalf to)
                    ...
                    a. the Site,
                    b. Fin-Tech (and its successors' and assigns') businesses,
                    ...
                    iv. use and publish, and permit others to use and publish, the User Submissions, Trademarks, names, likenesses, and personal and biographical materials of you and the members of your group, in connection with the provision or marketing of the Service. The foregoing license grant to Fin-Tech does not affect your other ownership or license rights in your User Submissions, including the right to grant additional licenses to your User Submissions.
                    The Campaigner agrees and grants Fin-Tech the right to use all the visual and text-based content (digital or non-digital) submitted by the Campaigner for his campaign(s), for the purpose of branding and marketing activities of the platform/ Fin-Tech. Notwithstanding anything in this Agreement, the Campaigner agrees to grant Fin-Tech an exclusive, perpetual, irrevocable rights and license, on worldwide basis, to monetize the Campaigner's project pitch video(s) through any means or medium deemed for by Fin-Tech, including various digital platforms such as Vimeo, Youtube etc.
                    Campaigner email database
                    The Campaigner hereby agrees to grant Fin-Tech unrestricted and unconditional access to the Campaigner’s contacts database (including email addresses, phone number, address, virtual profile handles, virtual profile address, virtual profile link, etc) and permits Fin-Tech, in perpetuity, to retain, save, access and reach out to all such persons / entities forming part of the Campaigner’s contacts database for the Campaigner’s Campaign as well as for any and all future campaigns launched on Fin-Tech, whether or not such campaigns are related to the Campaigner. It is clarified that the Campaigner shall share such Campaigner’s contacts database with Fin-Tech as part of formulating its Campaign.
                    Third-Party Sites
                    ...
                    Rewards delivery
                    Contribution towards the favourite campaign on the Site will be solely considered a voluntary contribution for which Funders will receive the incentive/reward mentioned in the amount slab chosen by the Funders. The Estimated Delivery Date of the reward given by the campaigner is not a promise to deliver the reward by that date, but is merely an estimate of when the campaigner hopes to deliver the reward. Delivery and fulfilment of the promised rewards to the Funders is the sole responsibility of the campaigner. The Company or the Site shall not be responsible for any liabilities resulting from Funders' dissatisfaction in relation to issues around incentives/rewards to be offered and fulfilled by the campaign owners.
                    Refund
                    Funders will get a refund of their contribution in case the campaign they are funding fails to achieve its target. The Funders agree to receive the refund either through a couriered cheque or via an online reversal/refund of their original payments. In case of a cheque refund (for cases where the initial contribution was made via cheque or bank transfer), the Funders agrees to allow Fin-Tech to deduct courier charges from the contribution. In case of an Online refund/ reversal (for cases of online Payment), the Funders agrees and acknowledges that the payment gateway has the right to deduct their charges from the refunded amount.
                    A Funder cannot ask for a refund if a campaign he/she funded met its target. The Funders relieve the Company or the Site from any obligation to make a refund in such a case.
                    In the event of an unreasonable delay beyond the period stipulated by the campaigner for fulfilment of the rewards, after a campaign has successfully met its target, a Funders may seek legal remedy directly against the campaigner / campaign owner.
                    ...
                    Campaigners and Funders agree to deal directly with each other, without involving Fin-Tech regarding any refund negotiations other than in the aforementioned scenario.
                    Rights of the project
                    Funders agree to not claim any ownership in the project they fund through the campaign on the Site. The rights of the project remain with the campaigner.
                    Dispute between campaigners and their Funders
                    ...
                    You (i.e. the campaigners and the Funders) hereby represent and warrant to Fin-Tech that:
                    i. all information provided by them during the registration / campaign / funding process, as applicable, is true and accurate;
                    ii. they are capable (in case of an individual, being above 18 years of age) and duly authorized (in case of a legal entity, by way of appropriate corporate approvals) to enter into the campaigning / funding arrangement, on behalf of himself, any other person, company, or other entity.
                    Covenants
                    No Person shall copy or utilise, in any manner, the questionnaire(s), responses, designs, content or any other data generated in consultation with Fin-Tech, without the prior written consent of Fin-Tech.
                    ...
                    • Users may not use the Company's Site for activities that:
                    ...
                    iii. remove or block any User or User Submission. Fin-Tech.in reserves the right not to comment on the reasons for any of these actions.
                    Termination
                    ...
                    • You further agree that your User Submissions will not contain third-party copyrighted material, or material that is subject to other third-party proprietary rights, unless you have permission from the rightful owner of the material or you are otherwise legally entitled to post the material and to grant Fin-Tech all of the license rights granted herein.
                    ...
                    • Fin-Tech reserves the right to cancel or suspend any campaign or delete any User Submission or terminate a User account if there is a complaint of infringement of the Content.
                    • Fin-Tech reserves the right to ban repeat infringers of Intellectual property from using the Site.
                    Indemnification
                    Notwithstanding anything herein, the campaigners and/or the Funders, as may be applicable, will not hold Fin-Tech responsible in the event of target not met. The campaigners and/or the Funders will also not hold Fin-Tech responsible for any unforeseen technical glitches such as but not limited to website down for maintenance, server errors, speed of website download, any viruses in the website etc., that might affect transaction activity on their campaigns or contribution transactions. Additionally, you (i.e. the campaigners and/or the Funders), as the case maybe, shall defend, indemnify and hold harmless Fin-Tech, it's affiliates, employees, contractors, directors, suppliers, and representatives from all direct and indirect liabilities, claims, and expenses, including reasonable attorneys' fees, that arise from or relate to your breach or non-compliance of any of the Terms of Use herein, misrepresentation, use or misuse of, or access to, the Service and Content, or otherwise from your User Submissions, violation of the Terms of Use, or infringement by you, or any third party using your account, of any intellectual property or other right of any person or entity. Fin-Tech reserves the right to assume the exclusive defense and control of any matter otherwise subject to indemnification by you, in which event you will assist and cooperate with the Wishbery in asserting any available defenses.
                    ...
                    i. for any lost profits, data loss, cost of procurement of substitute goods or services, or special, indirect, incidental, punitive, or consequential damages of any kind whatsoever, substitute goods or services (however arising) and
                    ...
                    • All proceedings of such arbitration shall be in the English language. The place / seat of the arbitration shall be Mumbai and the courts of Mumbai shall have exclusive jurisdiction over the arbitration proceedings;
                    • The Law governing the conduct of arbitration and the arbitration proceedings shall be the laws of India;
                    • The arbitration shall be conducted before a sole arbitrator appointed by Fin-Tech;
            ...
            <div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                <form class="login100-form validate-form" method="post" action="borrowp2p.php">
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Description is required">
                        ...
                        <input class="input100" type="text" name="username" placeholder="Description...">
                        <span class="focus-input100"></span>
                    </div>

                    <div class="wrap-input100 validate-input" data-validate="Amount is required">
                        <span class="label-input100">Amount Needed</span>
                        <input class="input100" type="text" name="pass" placeholder="in Indian Currency">
                        <span class="focus-input100"></span>
                    </div>
